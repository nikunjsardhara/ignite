              ...
              {[1, 2, 3].map((item, id) => (
                <>
                  <tr key={id}>
                    ...
                    <td className="text-center">
                      <span className="text-sm lg:text-base font-medium flex justify-center">
          ...
          <div className="my-4 mt-6 -mx-2 lg:flex">
            ...
            <div className="lg:px-2 lg:w-1/2">
              ...
              <div className="p-4">
                ...
                <a href="#">
                  <button className="flex items-center justify-center w-full px-10 py-3 mt-6 font-medium text-black uppercase bg-[wheat] rounded-full shadow item-center hover:bg-[#ebc57e] focus:shadow-outline focus:outline-none">
                    <svg
                      aria-hidden="true"
                      data-prefix="far"
